...
export function createAuthToken(user: { uid: string; email: string; displayName: string }): string {
...
export function verifyAuthToken(token: string): { uid: string; email: string; displayName: string } | null {
  try {
